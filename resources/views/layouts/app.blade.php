...
<body class="bg-background text-foreground antialiased min-h-screen flex flex-col">
    <header class="border-b border-stone-800 bg-stone-950/80 backdrop-blur sticky top-0 z-50" x-data="{ mobileMenuOpen: false }">
        <div class="content-shell flex items-center justify-between h-16">
            <a href="/" class="font-serif text-xl font-bold tracking-wide text-amber-500">Errant-Arts</a>
            <nav class="hidden md:flex items-center space-x-8 text-sm font-medium">
                <a href="/shop" class="hover:text-amber-500">Shop</a>
                <a href="/portfolio" class="hover:text-amber-500">Portfolio</a>
                <a href="/blog" class="hover:text-amber-500">Blog</a>
            </nav>
        ...
        <div x-show="mobileMenuOpen" x-cloak class="md:hidden border-b border-stone-800 bg-stone-900 px-4 py-4 space-y-3">
            <a href="/shop" class="block text-sm hover:text-amber-500">Shop</a>
            <a href="/portfolio" class="block text-sm hover:text-amber-500">Portfolio</a>
            <a href="/blog" class="block text-sm hover:text-amber-500">Blog</a>
        </div>
    </header>
